...
SECRET_KEY = 'django-insecure-%)-(a6kxt(j2p^i&_aue^^6-^vjs=lih%bdcq&elbk%e9x2%qv'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['bats.elusbakery.com','127.0.0.1','www.bats.elusbakery.com','localhost']
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'UserManagment.exceptions.custom_exception_handler',
}
